...
public:
  ...
  /// Returns true if the slot is marked as storing a column from the constraint system.
  bool isColumn() const { return markedColumn; }

  /// Marks wether the slot stores a column from the constraint system.
  void markColumn(bool column = true) { markedColumn = column; }
