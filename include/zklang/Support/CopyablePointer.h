//===- CopyablePointer.h - Pointer that copies ------------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file includes a smart pointer class that creates copies of the
// underlying object when the pointer is copied.
//
//===----------------------------------------------------------------------===//
