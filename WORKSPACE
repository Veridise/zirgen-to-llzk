...
ZKIR_COMMIT = "e4841a3146b317d5180146684fc95f114a0c0898"
...
# dependencies so we have to do the same thing here too for now.
...
register_toolchains(
    "@zirgen//bazel/rules/clang_format:toolchain",
)
